...
'ic10/catalog-control-plane/generic_catalog_store_v3_0.ic10':['poke 0 31415968','poke 1 6','poke 10 32','poke 19 32','poke 20 512'],
'ic10/catalog-control-plane/catalog_coordinator_core_v3_0.ic10':['poke 0 31415970','poke 1 4'],
...
'ic10/resource-profile-catalog/resource_profile_view_v4_0.ic10':['poke 0 31415963','poke 1 1','bne r0 6 Bad'],
'ic10/input-profile-catalog/input_profile_view_v5_0.ic10':['poke 0 31415929','poke 1 1','bne r0 6 Bad'],
'ic10/transform-catalog/resource_transform_profile_view_v8_0.ic10':['poke 0 31415952','poke 1 4','bne r0 6 Bad','poke 68 r10','poke 69 1'],
'ic10/recipe-catalog/recipe_catalog_lookup_v8_0.ic10':['poke 0 31415967','poke 1 3','bne r0 6 CatalogBad',],
...
'ic10/manufacturing/generic_print_runtime_v2_0.ic10':['poke 0 31416075','poke 1 2'],
'ic10/manufacturing/transform_job_driver_v2_0.ic10':['poke 0 31416076','poke 1 2'],
...
# consumer that checks only S0 would accept the wrong one.
import re
published={}
for p in sorted(R.glob('ic10/*/*.ic10')):
 t=p.read_text();m=re.search(r'^poke 0 (\d+)$',t,re.M);a=re.search(r'^poke 1 (\d+)$',t,re.M)
 if m and a:published.setdefault(m.group(1),{}).setdefault(a.group(1),[]).append(p.relative_to(R).as_posix())
