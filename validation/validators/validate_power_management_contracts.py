...
need('ic10/power-grid/power_reservation_directory_adapter_v1_0.ic10','HASH("DirectorySchema.PowerReservation")','poke 4 3','poke 5 64','getd r0 r1 17','get r13 db 14','1000000','5000000')
