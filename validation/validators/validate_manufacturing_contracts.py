...
need('ic10/recipe-catalog/recipe_execution_profile_view_v1_0.ic10','poke 0 HASH("RecipeExecutionProfileView.v1")','poke 1 1','bgt r4 16 Bad','poke 49 r10')
...
need('ic10/manufacturing/transform_candidate_readiness_v1_0.ic10','poke 0 HASH("TransformCandidateReadiness.v1")','poke 1 1','getd r0 r12 68','bne r0 r2 Loop','getd r7 r9 9','beq r7 r0 Loop','getd r7 r10 13','beq r7 r0 Loop','move r0 -2','move r0 -3','move r0 -4')
...
need('ic10/manufacturing/manufacturing_scheduler_v1_0.ic10','poke 0 HASH("ManufacturingScheduler.v1")','put d0 11 2','put d0 13 r1','put d0 14 r4','put d0 15 r5','add r4 r2 1')
