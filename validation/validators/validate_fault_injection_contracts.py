...
result.ordered('ic10/material-transform/generic_material_transform_runtime_v2_0.ic10','s d0 Activate 0','poke 19 0','poke 20 -1',after='Fault:',rule='fault publishes state before status')
