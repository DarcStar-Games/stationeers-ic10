...
required={
 'ROADMAP.md':['9. Power-management reuse — COMPLETE','10. Broad interruption and fault-injection suite — COMPLETE','11. Cross-domain process & utility orchestration — COMPLETE','12. Live-game commissioning and evidence closure — ACTIVE','13. Manufacturing demand and job ingress — IN PROGRESS','Items **1–11 are implemented and automatically validated**','Item **12 is ACTIVE**','docs/LIVE_COMMISSIONING.md','docs/STOCK_TARGET_INGRESS.md','docs/COMPLETED_MILESTONES.md'],
 ...
 'docs/DEPENDENCY_PLANNING.md':['199 Job Command Gateway ABI4','ic10/generic-jobs/generic_job_store_command_executor_v1_0.ic10','ic10/dependency-planning/dependency_plan_store_v2_0.ic10','QuoteFingerprintA','active','FutureQty','root job -> child -> grandchild','physical reservation authority'],
 'docs/ABI_REFERENCE.md':['Store ABI6','Loader ABI5','Coordinator ABI4','DIRECTORY_ADAPTER_ABI_V3','Generic Snapshot Directory Host','DirectorySchema.Controller','DirectorySchema.ResourceReservation','DirectorySchema.Printer','ProcessorSpec','DirectorySchema.PrinterExecution','Generic Job Store ABI v1','-955081679','Transform Profile ABI4','RequiredCapabilityMask','Recipe schema v3','Manufacturing Scheduler','ABI2 exactly','Power Management ABIs — current','DirectorySchema.PowerReservation','S6','S7','ic10/generic-jobs/generic_job_command_gateway_v4_0.ic10'],
 'README.md':['ROADMAP.md','docs/PROCESS_UTILITY_ORCHESTRATION.md','docs/INTERRUPTION_FAULT_INJECTION.md','docs/LIVE_COMMISSIONING.md','docs/STOCK_TARGET_INGRESS.md','complete validator/test inventory defined by `framework/validation_suite.py`','docs/DEPENDENCY_PLANNING.md','docs/COMPLETED_MILESTONES.md','docs/CATALOG_COORDINATION.md','docs/CATALOG_STORAGE.md','docs/DIRECTORY_STANDARD.md','docs/PRINTER_DIRECTORY.md','docs/GENERIC_JOB_ABI.md','docs/MANUFACTURING_SCHEDULER.md','docs/ASYNC_REQUEST_STANDARD.md','docs/BANKED_TRANSACTION_STANDARD.md','docs/SCRIPT_INDEX.md','tools/run_validation.py','tools/build_release.py','ic10/printer-directory/printer_directory_adapter_v1_0.ic10','ic10/generic-jobs/generic_job_store_v1_0.ic10','ic10/manufacturing/manufacturing_scheduler_v1_0.ic10','docs/POWER_MANAGEMENT.md','ic10/generic-jobs/generic_job_command_gateway_v4_0.ic10','ic10/power-jobs/power_job_scheduler_v1_0.ic10'],
 ...
 'docs/MANUFACTURING_SCHEDULER.md':['ic10/generic-jobs/generic_job_selector_v3_0.ic10','Job Command Gateway ABI4','ic10/dependency-planning/manufacturing_dependency_gate_v2_0.ic10','ic10/generic-jobs/generic_job_store_command_executor_v1_0.ic10','ic10/manufacturing/manufacturing_driver_router_v2_0.ic10','ic10/manufacturing/manufacturing_scheduler_v1_0.ic10','ic10/manufacturing/transform_candidate_readiness_v1_0.ic10','DirectorySchema.TransformLane','DirectorySchema.PrinterExecution','ManufacturingReagentHash','one reusable **dynamic** selector','scheduling cursor','ExpectedPrinterRef','OwnerPrinterRef','sole physical Job Store mailbox writer','WAIT_CAPACITY','pressure','temperature'],
 'docs/STOCK_TARGET_INGRESS.md':['Roadmap Item 13.1','exactOnHand','unclaimedActiveOutput','Hysteresis','Gateway lane E','expected Job Store QueueSequence','expected Dependency Plan Store sequence','lower-bound inventory','LG-STOCK-TARGET-INGRESS','tests/test_stock_target_ingress.py'],
}
