...
required={
 ...
 'docs/DEPENDENCY_PLANNING.md':['199 Job Command Gateway ABI5','ic10/generic-jobs/generic_job_store_command_executor_v1_0.ic10','ic10/dependency-planning/dependency_plan_store_v2_0.ic10','QuoteFingerprintA','active','FutureQty','root job -> child -> grandchild','physical reservation authority'],
 'docs/ABI_REFERENCE.md':['Store ABI6','Loader ABI5','Coordinator ABI4','DIRECTORY_ADAPTER_ABI_V3','Generic Snapshot Directory Host','DirectorySchema.Controller','DirectorySchema.ResourceReservation','DirectorySchema.Printer','ProcessorSpec','DirectorySchema.PrinterExecution','Generic Job Store ABI v1','-955081679','Transform Profile ABI4','RequiredCapabilityMask','Recipe schema v3','Manufacturing Scheduler','ABI2 exactly','Power Management ABIs — current','DirectorySchema.PowerReservation','S6','S7','ic10/generic-jobs/generic_job_command_gateway_v5_0.ic10'],
 ...
 'docs/OPERATOR_ORDER_INGRESS.md':['Roadmap Item 13.2','FamilyOrdinal','Gateway ABI5 lane F','held level cannot become a new edge','LG-OPERATOR-ORDER-INGRESS','tests/test_operator_order_ingress.py'],
}
