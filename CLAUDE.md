...
A deployable framework of **184 Stationeers IC10 assembly programs** (`ic10/**/*.ic10`) plus a Python
...
| Path | Holds | Notes |
|---|---|---|
| `ic10/<deployment-family>/` | the product: 184 production IC10 programs | never generated by hand except where noted below |
