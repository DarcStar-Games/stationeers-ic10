...
def render(s):
 ...
 lines=[f"# {s['comment']}",'Boot:','clr db','poke 0 31415983','poke 1 3','poke 2 17',f'poke 3 HASH("{s["schema"]}.v1")',f'poke 8 HASH("{s["schema"]}")','poke 9 1','poke 10 {}'.format(w),'poke 11 64','poke 15 1']
