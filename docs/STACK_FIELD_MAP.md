...
Protocols with a layout: 106. Layout entries: 1105. Cells named: 3867.

## Roles

| Role | Meaning | Entries |
|---|---|---:|
| metadata | static published configuration or capability: width, capacity, unit, class, limit | 54 |
...
| request_token | request identity a caller writes last | 85 |
| current_token | LIVE_CURRENT accepted-request identity the service publishes | 6 |
| response_token | TERMINAL_RESPONSE handled-request identity the service publishes last | 79 |
| state | status, state, or mode of the service or of the current request | 103 |
| error | error or fault detail kept apart from the state cell | 7 |
| result | response payload the service publishes before its token | 250 |
| generation | publication generation, odd/even sequence, or revision that fences observation | 60 |
| epoch | epoch, lease, or ownership value that authorizes mutation | 18 |
| bank | A/B bank select and the per-bank generation, count, and overflow cells | 12 |
| topology | ReferenceId of a peer service or device, or a chain link between peers | 49 |
| table | record array, slot table, image, heap, or descriptor pool | 23 |
| telemetry | observational channel for operators and monitors | 12 |
| reserved | held cell that nothing interprets | 1 |
...
54 entries at 26 distinct starting cells: S8, S9, S10, S11, S12, S13, S14, S15, S16, S17, S18, S19, S20, S23, S28, S30, S31, S32, S33, S34, S35, S48, S52, S53, S54, S99.
...
| S10 | CatalogInstanceId | ic10.stack.catalog-loader.v5 | 2 | 0 | 5 |
| S10 | EntryWidth | ic10.stack.directory-adapter.v3 | 2 | 2 | 2 |
| S10 | BlockCount | ic10.stack.generic-persistent-config-host.v1 | 7 | 13 | -1 |
...
| S11 | PartitionKey | ic10.stack.catalog-loader.v5 | 2 | 0 | 5 |
...
| S13 | CatalogInstanceId | ic10.stack.generic-catalog-store.v6 | 6 | 1 | 0 |
...
| S14 | ItemCount | ic10.stack.catalog-loader.v5 | 2 | 0 | 5 |
...
| S17 | ActiveFieldCount | ic10.stack.generic-config-editor.v1 | 2 | 0 | 12 |
| S17 | CapabilityMask | ic10.stack.generic-input-scanner.v1 | 0 | 0 | 36 |
| S18 | NodeId | ic10.stack.generic-catalog-store.v6 | 2 | 1 | 0 |
| S18 | Capacity | ic10.stack.generic-job-store.v1 | 0 | 6 | -1 |
| S18 | Role | ic10.stack.pressure-inventory-reservation.v1 | 2 | 1 | 70 |
| S19 | MediumType | ic10.stack.pressure-inventory-reservation.v1 | 3 | 1 | 70 |
| S20..S22 | ClassConfiguration | ic10.stack.resource-endpoint.v1 | 1 | 1 | -1 |
| S23 | PartitionKey | ic10.stack.generic-catalog-store.v6 | 3 | 1 | 0 |
| S23 | FluidResourceType | ic10.stack.process-condition.v1 | 2 | 1 | 4 |
| S28 | ValidatedProfileAbi | ic10.stack.generic-config-editor.v1 | 1 | 0 | 12 |
| S30 | LoadedBlockCount | ic10.stack.generic-config-editor.v1 | 2 | 0 | 12 |
...
| S48 | ControllerType | ic10.stack.generic-persistent-config-host.v1 | 8 | 13 | -1 |
...
| S99 | ControllerType | ic10.stack.27182818.abi2 | 5 | 4 | -7 |
...
| S19 | ControllerConfigSchema | ic10.stack.generic-config-editor.v1 | 2 | 0 | 12 |
| S50 | ControllerConfigSchema | ic10.stack.generic-persistent-config-host.v1 | 8 | 13 | -1 |
...
| Cells | Name | Protocol | Peers | Consumers | Headroom |
|---|---|---|---:|---:|---:|
| S8 | RecordCount | ic10.stack.diagnostic-renderer.v1 | 1 | 0 | 53 |
| S8 | BatchCount | ic10.stack.generic-material-transform-runtime.v2 | 1 | 0 | 0 |
...
| S9 | LogicalControlCount | ic10.stack.generic-input-resolver.v1 | 3 | 1 | 10 |
| S9 | RequestedControlCount | ic10.stack.generic-input-scanner.v1 | 1 | 0 | 36 |
...
| S10 | DesiredControllerType | ic10.stack.controller-selector.v2 | 1 | 0 | 9 |
| S10 | ParentJobId | ic10.stack.dependency-ancestry-guard.v1 | 1 | 0 | 37 |
| S10 | ProfileRef | ic10.stack.generic-input-resolver.v1 | 3 | 1 | 10 |
...
| S11 | DesiredControllerMember | ic10.stack.controller-selector.v2 | 1 | 0 | 9 |
...
| S12 | DesiredConsole | ic10.stack.console-selector.v1 | 1 | 0 | 29 |
...
| S12 | DesiredControllerRef | ic10.stack.generic-config-editor.v1 | 1 | 0 | 12 |
...
| S16 | StagedQuantity | ic10.stack.material-transfer-grant-guard.v1 | 1 | 2 | 6 |
...
| S19 | StagedSourceReservationRef | ic10.stack.material-transfer-grant-guard.v1 | 1 | 2 | 6 |
...
| S20 | BridgeImageSlot | ic10.stack.generic-config-editor.v1 | 1 | 0 | 12 |
...
| S20 | StagedSinkReservationRef | ic10.stack.material-transfer-grant-guard.v1 | 1 | 2 | 6 |
...
| S21 | BridgeResolvedValue | ic10.stack.generic-config-editor.v1 | 1 | 0 | 12 |
...
| S21 | StagedResourceType | ic10.stack.material-transfer-grant-guard.v1 | 1 | 2 | 6 |
...
| S22 | BridgeInputKind | ic10.stack.generic-config-editor.v1 | 1 | 0 | 12 |
...
| S22 | StagedFeederRef | ic10.stack.material-transfer-grant-guard.v1 | 1 | 2 | 6 |
...
| S23 | StagedSorterRef | ic10.stack.material-transfer-grant-guard.v1 | 1 | 2 | 6 |
...
| S24 | StagedSinkProviderRef | ic10.stack.material-transfer-grant-guard.v1 | 1 | 2 | 6 |
...
| S25 | CapacityRequestPending | ic10.stack.catalog-coordinator-core.v4 | 2 | 1 | 8 |
...
| S25 | StagedLinkRef | ic10.stack.material-transfer-grant-guard.v1 | 1 | 2 | 6 |
...
| S26 | RequestPartitionKey | ic10.stack.catalog-coordinator-core.v4 | 2 | 1 | 8 |
...
| S26 | StagedExecutorRef | ic10.stack.material-transfer-grant-guard.v1 | 1 | 2 | 6 |
...
| S27 | RequestCatalogSchemaId | ic10.stack.catalog-coordinator-core.v4 | 2 | 1 | 8 |
...
| S29 | RequestCatalogInstanceId | ic10.stack.catalog-coordinator-core.v4 | 2 | 1 | 8 |
...
| S30 | RequestTailStoreRef | ic10.stack.catalog-coordinator-core.v4 | 2 | 1 | 8 |
| S30 | MoveExpectedQuantity | ic10.stack.resource-endpoint.v1 | 1 | 1 | -1 |
| S31 | RequestNextStoreOrdinal | ic10.stack.catalog-coordinator-core.v4 | 2 | 1 | 8 |
| S31 | OutputPerBatch | ic10.stack.stock-target-job-ingress.v1 | 1 | 1 | 0 |
| S32 | RequestRequiredCells | ic10.stack.catalog-coordinator-core.v4 | 2 | 1 | 8 |
...
| S50 | PolicyOverride | ic10.stack.resource-endpoint.v1 | 1 | 1 | -1 |
| S51 | WattOverride | ic10.stack.resource-endpoint.v1 | 1 | 1 | -1 |
...
| S108 | StagedGrantMolesPerTick | ic10.stack.27182818.abi2 | 3 | 4 | -7 |
| S110 | StagedPlannerReferenceId | ic10.stack.27182818.abi2 | 2 | 4 | -7 |
| S111 | StagedLeaseTicks | ic10.stack.27182818.abi2 | 2 | 4 | -7 |
| S117 | StagedSourceReservationReferenceId | ic10.stack.27182818.abi2 | 2 | 4 | -7 |
| S118 | StagedSinkReservationReferenceId | ic10.stack.27182818.abi2 | 2 | 4 | -7 |
| S119 | StagedMediumType | ic10.stack.27182818.abi2 | 2 | 4 | -7 |
| S120 | StagedRouteKind | ic10.stack.27182818.abi2 | 2 | 4 | -7 |

### request_token

85 entries at 29 distinct starting cells: S8, S9, S10, S11, S12, S13, S14, S15, S16, S18, S19, S20, S21, S22, S23, S24, S25, S29, S30, S31, S32, S33, S36, S48, S52, S64, S70, S80, S96.
...
| S10 | AdvanceRequestToken | ic10.stack.console-selector.v1 | 1 | 0 | 29 |
...
| S12 | RequestToken | ic10.stack.controller-selector.v2 | 1 | 0 | 9 |
...
| S13 | DesiredRequestToken | ic10.stack.console-selector.v1 | 1 | 0 | 29 |
...
| S16 | RequestToken | ic10.stack.generic-material-transform-runtime.v2 | 1 | 0 | 0 |
...
| S52 | RequestGeneration | ic10.stack.generic-persistent-config-host.v1 | 7 | 13 | -1 |
| S64 | LaneDRequestToken | ic10.stack.generic-job-command-gateway.v5 | 1 | 2 | 0 |
| S70 | TransformTypeRequest | ic10.stack.resource-transform-profile-view.v4 | 2 | 4 | 4 |
...
| S21 | CurrentToken | ic10.stack.generic-material-transform-runtime.v2 | 1 | 0 | 0 |
| S25 | CurrentEpoch | ic10.stack.stacker-feeder.v1 | 1 | 1 | -7 |

### response_token

79 entries at 27 distinct starting cells: S8, S9, S10, S11, S12, S13, S14, S15, S16, S17, S19, S20, S21, S22, S23, S24, S26, S30, S31, S33, S34, S49, S53, S65, S68, S81, S97.
...
| S11 | HandledAdvanceToken | ic10.stack.console-selector.v1 | 1 | 0 | 29 |
...
| S14 | HandledDesiredToken | ic10.stack.console-selector.v1 | 1 | 0 | 29 |
...
| S53 | ResponseGeneration | ic10.stack.generic-persistent-config-host.v1 | 7 | 13 | -1 |
| S65 | LaneDResponseToken | ic10.stack.generic-job-command-gateway.v5 | 1 | 2 | 0 |
| S68 | RequestEcho | ic10.stack.resource-transform-profile-view.v4 | 5 | 4 | 4 |
...
103 entries at 27 distinct starting cells: S8, S9, S10, S11, S12, S13, S14, S15, S16, S17, S18, S20, S21, S22, S24, S25, S27, S28, S31, S32, S35, S50, S66, S69, S82, S98, S101.

| Cells | Name | Protocol | Peers | Consumers | Headroom |
|---|---|---|---:|---:|---:|
| S8 | OperationalStatus | ic10.stack.generic-persistent-config-host.v1 | 7 | 13 | -1 |
...
| S9 | EndpointStatus | ic10.stack.resource-reservation.v1 | 3 | 3 | 4 |
...
| S10 | MirroredInventoryStatus | ic10.stack.pressure-inventory-reservation.v1 | 1 | 1 | 70 |
| S10 | Active | ic10.stack.process-condition.v1 | 3 | 1 | 4 |
| S11 | Status | ic10.stack.dependency-plan-store.v2 | 2 | 6 | 4 |
| S11 | Status | ic10.stack.generic-input-resolver.v1 | 3 | 1 | 10 |
...
| S15 | StagingReady | ic10.stack.generic-config-editor.v1 | 2 | 0 | 12 |
...
| S16 | StoreState | ic10.stack.generic-catalog-store.v6 | 5 | 1 | 0 |
| S16 | EditorStatus | ic10.stack.generic-config-editor.v1 | 2 | 0 | 12 |
| S16 | Status | ic10.stack.generic-job-monitor.v1 | 4 | 0 | 56 |
| S16 | ExecutionStatus | ic10.stack.material-transfer-executor.v1 | 1 | 1 | 2 |
| S16 | DirectionLock | ic10.stack.resource-reservation.v1 | 5 | 3 | 4 |
| S17 | Status | ic10.stack.console-selector.v1 | 1 | 0 | 29 |
...
| S18 | Ready | ic10.stack.catalog-loader.v5 | 2 | 0 | 5 |
| S20 | Status | ic10.stack.dependency-claim-view.v1 | 3 | 1 | 5 |
| S20 | Status | ic10.stack.generic-material-transform-runtime.v2 | 1 | 0 | 0 |
...
| S21 | ImportedItemIndex | ic10.stack.catalog-loader.v5 | 2 | 0 | 5 |
...
| S25 | BridgePublicationValid | ic10.stack.generic-config-editor.v1 | 1 | 0 | 12 |
...
| S69 | ResolveStatus | ic10.stack.resource-transform-profile-view.v4 | 5 | 4 | 4 |
...
7 entries at 3 distinct starting cells: S9, S11, S12.
...
250 entries at 46 distinct starting cells: S8, S9, S10, S11, S12, S13, S14, S15, S16, S17, S18, S19, S20, S21, S22, S23, S24, S25, S26, S27, S28, S29, S30, S31, S32, S33, S34, S35, S36, S37, S38, S39, S40, S41, S51, S55, S56, S57, S64, S71, S72, S73, S83, S84, S99, S100.
...
| S9 | LocalItemCount | ic10.stack.generic-catalog-store.v6 | 3 | 1 | 0 |
...
| S10 | SelectedControlOrdinal | ic10.stack.generic-input-scanner.v1 | 1 | 0 | 36 |
...
| S11 | TransactionResult | ic10.stack.generic-persistent-config-host.v1 | 1 | 13 | -1 |
...
| S12 | ReservedExportMoles | ic10.stack.pressure-inventory-reservation.v1 | 1 | 1 | 70 |
...
| S13 | SelectedControlOrdinal | ic10.stack.generic-input-resolver.v1 | 3 | 1 | 10 |
...
| S13 | ReservedImportMoles | ic10.stack.pressure-inventory-reservation.v1 | 1 | 1 | 70 |
...
| S14 | ResolvedValue | ic10.stack.generic-input-resolver.v1 | 3 | 1 | 10 |
...
| S14 | ReservedExport | ic10.stack.resource-reservation.v1 | 5 | 3 | 4 |
| S14 | BufferQuantity | ic10.stack.stacker-feeder.v1 | 1 | 1 | -7 |
| S15 | ResolvedInputKind | ic10.stack.generic-input-resolver.v1 | 1 | 1 | 10 |
...
| S15 | ReservedImport | ic10.stack.resource-reservation.v1 | 5 | 3 | 4 |
| S15 | BufferResourceType | ic10.stack.stacker-feeder.v1 | 1 | 1 | -7 |
| S16 | DisplayRef | ic10.stack.console-selector.v1 | 1 | 0 | 29 |
...
| S19 | NextDirectoryCell | ic10.stack.generic-catalog-store.v6 | 1 | 1 | 0 |
...
| S20 | HeapTop | ic10.stack.generic-catalog-store.v6 | 1 | 1 | 0 |
...
| S20 | ExportableMoles | ic10.stack.pressure-inventory-reservation.v1 | 3 | 1 | 70 |
...
| S21 | ImportCapacityMoles | ic10.stack.pressure-inventory-reservation.v1 | 3 | 1 | 70 |
...
| S22 | UsedCells | ic10.stack.generic-catalog-store.v6 | 3 | 1 | 0 |
...
| S22 | MirroredActionHint0 | ic10.stack.resource-reservation.v1 | 1 | 3 | 4 |
...
| S23 | MirroredActionHint1 | ic10.stack.resource-reservation.v1 | 1 | 3 | 4 |
...
| S24 | MirroredActionHint2 | ic10.stack.resource-reservation.v1 | 1 | 3 | 4 |
...
| S25 | CommittedSourceSlot | ic10.stack.resource-reservation.v1 | 3 | 3 | 4 |
...
| S26 | CommittedActionQuantity | ic10.stack.resource-reservation.v1 | 3 | 3 | 4 |
...
| S27 | InFlightReservationCells | ic10.stack.generic-catalog-store.v6 | 3 | 1 | 0 |
...
| S27 | CommittedDestinationSlot | ic10.stack.resource-reservation.v1 | 3 | 3 | 4 |
| S28 | AllocatedJobId | ic10.stack.stock-target-job-ingress.v1 | 1 | 1 | 0 |
| S29 | FreeCells | ic10.stack.generic-catalog-store.v6 | 3 | 1 | 0 |
...
| S36 | ExportAvailable | ic10.stack.resource-reservation.v1 | 3 | 3 | 4 |
...
| S37 | ImportCapacity | ic10.stack.resource-reservation.v1 | 3 | 3 | 4 |
...
| S71 | RequiredCapabilityMask | ic10.stack.resource-transform-profile-view.v4 | 3 | 4 | 4 |
| S72 | InputCount | ic10.stack.resource-transform-profile-view.v4 | 3 | 4 | 4 |
| S73 | OutputCount | ic10.stack.resource-transform-profile-view.v4 | 2 | 4 | 4 |
...
60 entries at 26 distinct starting cells: S9, S10, S11, S12, S13, S14, S15, S16, S17, S18, S19, S21, S22, S23, S24, S26, S27, S28, S29, S30, S40, S42, S51, S74, S104, S115.
...
| S11 | StagingRevision | ic10.stack.generic-config-editor.v1 | 2 | 0 | 12 |
...
| S12 | SnapshotGeneration | ic10.stack.generic-input-resolver.v1 | 3 | 1 | 10 |
| S12 | SnapshotGeneration | ic10.stack.generic-input-scanner.v1 | 1 | 0 | 36 |
...
| S12 | MirrorGeneration | ic10.stack.resource-reservation.v1 | 9 | 3 | 4 |
| S13 | RebuildSequence | ic10.stack.directory-adapter.v3 | 2 | 2 | 2 |
| S13 | CaptureStagingRevision | ic10.stack.generic-config-editor.v1 | 1 | 0 | 12 |
...
| S15 | ImportGeneration | ic10.stack.generic-catalog-store.v6 | 2 | 1 | 0 |
...
| S19 | ReservedSemanticMirrorGeneration | ic10.stack.resource-reservation.v1 | 4 | 3 | 4 |
...
| S26 | BridgeHostSnapshot | ic10.stack.generic-config-editor.v1 | 1 | 0 | 12 |
...
| S29 | ValidatedProfileGeneration | ic10.stack.generic-config-editor.v1 | 2 | 0 | 12 |
...
| S74 | PublicationGeneration | ic10.stack.resource-transform-profile-view.v4 | 5 | 4 | 4 |
| S104 | ApplyGeneration | ic10.stack.generic-config-editor.v1 | 2 | 0 | 12 |
| S115 | TelemetryGeneration | ic10.stack.27182818.abi2 | 3 | 4 | -7 |

### epoch

18 entries at 14 distinct starting cells: S9, S10, S12, S13, S14, S15, S16, S17, S18, S20, S23, S26, S31, S109.
...
| S12 | CoordinatorEpoch | ic10.stack.generic-catalog-store.v6 | 2 | 1 | 0 |
| S13 | BuildEpoch | ic10.stack.resource-reservation.v1 | 4 | 3 | 4 |
...
| S14 | BuildEpoch | ic10.stack.pressure-inventory-reservation.v1 | 1 | 1 | 70 |
...
| S17 | StagedEpoch | ic10.stack.material-transfer-grant-guard.v1 | 1 | 2 | 6 |
| S18 | OwnerEpoch | ic10.stack.resource-reservation.v1 | 4 | 3 | 4 |
| S20 | AssignmentEpoch | ic10.stack.catalog-loader.v5 | 1 | 0 | 5 |
| S23 | RuntimeCompletionEpoch | ic10.stack.multi-material-reservation-allocator.v2 | 1 | 1 | 5 |
| S26 | AssignmentEpoch | ic10.stack.generic-catalog-store.v6 | 2 | 1 | 0 |
| S31 | CommittedAssignmentEpoch | ic10.stack.generic-catalog-store.v6 | 2 | 1 | 0 |
| S109 | StagedEpoch | ic10.stack.27182818.abi2 | 3 | 4 | -7 |
...
49 entries at 23 distinct starting cells: S8, S9, S10, S11, S12, S13, S14, S15, S16, S17, S18, S19, S20, S21, S22, S24, S27, S28, S29, S32, S40, S41, S100.
...
| S8 | StoreOrdinal | ic10.stack.generic-catalog-store.v6 | 2 | 1 | 0 |
...
| S10 | LoadedControllerRef | ic10.stack.generic-config-editor.v1 | 2 | 0 | 12 |
| S10 | NativeLinkRef | ic10.stack.resource-link.v1 | 0 | 1 | 12 |
| S11 | CoordinatorRef | ic10.stack.generic-catalog-store.v6 | 8 | 1 | 0 |
...
| S14 | ClaimCoordinatorId | ic10.stack.generic-catalog-store.v6 | 2 | 1 | 0 |
| S14 | CapturedControllerRef | ic10.stack.generic-config-editor.v1 | 1 | 0 | 12 |
...
| S15 | OwningPlannerRef | ic10.stack.pressure-inventory-reservation.v1 | 1 | 1 | 70 |
...
| S17 | OwnerReferenceId | ic10.stack.resource-reservation.v1 | 4 | 3 | 4 |
| S18 | ConfigHostRef | ic10.stack.generic-config-editor.v1 | 3 | 0 | 12 |
| S18 | AllocatorRef | ic10.stack.material-transfer-grant-guard.v1 | 1 | 2 | 6 |
| S19 | TargetStoreRef | ic10.stack.catalog-loader.v5 | 2 | 0 | 5 |
| S20 | RuntimeRef | ic10.stack.multi-material-reservation-allocator.v2 | 2 | 1 | 5 |
| S21 | PreviousStoreRef | ic10.stack.generic-catalog-store.v6 | 3 | 1 | 0 |
| S22 | TargetRef | ic10.stack.process-condition.v1 | 1 | 1 | 4 |
| S24 | NextStoreRef | ic10.stack.generic-catalog-store.v6 | 3 | 1 | 0 |
| S27 | ValidatedProfileRef | ic10.stack.generic-config-editor.v1 | 2 | 0 | 12 |
...
23 entries at 12 distinct starting cells: S8, S16, S18, S20, S32, S58, S64, S96, S128, S160, S192, S288.
...
| S20..S31 | LinkRecords | ic10.stack.material-transform-link-resolver.v1 | 2 | 0 | 2 |
...
| S32..S63 | OutputDescriptors | ic10.stack.resource-transform-profile-view.v4 | 3 | 4 | 4 |
...
12 entries at 12 distinct starting cells: S35, S36, S37, S38, S39, S40, S41, S42, S43, S44, S45, S100.
...
| S100..S107 | TelemetryChannels | ic10.stack.27182818.abi2 | 4 | 4 | -7 |

### reserved

1 entries at 1 distinct starting cells: S32.

| Cells | Name | Protocol | Peers | Consumers | Headroom |
|---|---|---|---:|---:|---:|
| S32..S83 | UnusedRecordWindow | ic10.stack.material-transform-link-resolver.v1 | 1 | 0 | 2 |
...
| Cells | Name | Role | Peers | Description |
|---|---|---|---:|---|
| S99 | ControllerType | metadata | 5 | controller family hash |
| S100..S107 | TelemetryChannels | telemetry | 4 | channel n at S99+n; meanings are per controller family |
| S108 | StagedGrantMolesPerTick | request | 3 | Allocator-owned staged grant consumed by the paired Grant Guard |
| S109 | StagedEpoch | epoch | 3 | Allocator commit marker written after the staged payload |
| S110 | StagedPlannerReferenceId | request | 2 |  |
| S111 | StagedLeaseTicks | request | 2 |  |
| S115 | TelemetryGeneration | generation | 3 | written last; payload precedes it |
| S117 | StagedSourceReservationReferenceId | request | 2 |  |
| S118 | StagedSinkReservationReferenceId | request | 2 |  |
| S119 | StagedMediumType | request | 2 |  |
| S120 | StagedRouteKind | request | 2 |  |
...
| S25 | CapacityRequestPending | request | 2 | Router capacity request in S25..S32 |
| S26 | RequestPartitionKey | request | 2 |  |
| S27 | RequestCatalogSchemaId | request | 2 |  |
| S29 | RequestCatalogInstanceId | request | 2 |  |
| S30 | RequestTailStoreRef | request | 2 |  |
| S31 | RequestNextStoreOrdinal | request | 2 |  |
| S32 | RequestRequiredCells | request | 2 |  |
...
| Cells | Name | Role | Peers | Description |
|---|---|---|---:|---|
| S10 | CatalogInstanceId | metadata | 2 |  |
| S11 | PartitionKey | metadata | 2 |  |
| S14 | ItemCount | metadata | 2 |  |
| S18 | Ready | state | 2 | immutable candidate publication, written last |
| S19 | TargetStoreRef | topology | 2 | Router-owned placement; begins zero |
| S20 | AssignmentEpoch | epoch | 1 | Router-owned assignment token; begins zero |
| S21 | ImportedItemIndex | state | 2 | next imported item index, advanced by the Router and Store |
...
| Cells | Name | Role | Peers | Description |
|---|---|---|---:|---|
| S10 | AdvanceRequestToken | request_token | 1 |  |
| S11 | HandledAdvanceToken | response_token | 1 |  |
| S12 | DesiredConsole | request | 1 |  |
| S13 | DesiredRequestToken | request_token | 1 |  |
| S14 | HandledDesiredToken | response_token | 1 |  |
| S16 | DisplayRef | result | 1 |  |
| S17 | Status | state | 1 | 1 resolved |
...
| Cells | Name | Role | Peers | Description |
|---|---|---|---:|---|
| S10 | DesiredControllerType | request | 1 |  |
| S11 | DesiredControllerMember | request | 1 |  |
...
| Cells | Name | Role | Peers | Description |
|---|---|---|---:|---|
| S8 | RecordCount | request | 1 | committed mapping records at S64.., five cells each |
...
| Cells | Name | Role | Peers | Description |
|---|---|---|---:|---|
| S8 | StoreOrdinal | topology | 2 | Coordinator-owned; written at claim |
| S9 | LocalItemCount | result | 3 |  |
| S11 | CoordinatorRef | topology | 8 |  |
| S12 | CoordinatorEpoch | epoch | 2 |  |
| S13 | CatalogInstanceId | metadata | 6 | assigned by the Coordinator |
| S14 | ClaimCoordinatorId | topology | 2 |  |
| S15 | ImportGeneration | generation | 2 | committed item-import generation/count |
| S16 | StoreState | state | 5 |  |
| S17 | DataSequence | generation | 1 | odd while mutating, even stable |
| S18 | NodeId | metadata | 2 | human-assigned 1..64 |
| S19 | NextDirectoryCell | result | 1 |  |
| S20 | HeapTop | result | 1 |  |
| S21 | PreviousStoreRef | topology | 3 |  |
| S22 | UsedCells | result | 3 |  |
| S23 | PartitionKey | metadata | 3 |  |
| S24 | NextStoreRef | topology | 3 |  |
| S26 | AssignmentEpoch | epoch | 2 |  |
| S27 | InFlightReservationCells | result | 3 | capacity promised to an in-flight placement or migration |
| S29 | FreeCells | result | 3 |  |
| S31 | CommittedAssignmentEpoch | epoch | 2 |  |
...
| Cells | Name | Role | Peers | Description |
|---|---|---|---:|---|
| S10 | LoadedControllerRef | topology | 2 |  |
| S11 | StagingRevision | generation | 2 |  |
| S12 | DesiredControllerRef | request | 1 |  |
| S13 | CaptureStagingRevision | generation | 1 | staging revision captured at Apply |
| S14 | CapturedControllerRef | topology | 1 | controller ReferenceId captured at Apply |
| S15 | StagingReady | state | 2 |  |
| S16 | EditorStatus | state | 2 | 1 LOADING, 3 MODIFIED, 4 APPLY PENDING |
| S17 | ActiveFieldCount | metadata | 2 |  |
| S18 | ConfigHostRef | topology | 3 |  |
| S19 | ControllerConfigSchema | schema | 2 |  |
| S20 | BridgeImageSlot | request | 1 | physical image slot 0..31 selected through the Config Bridge |
| S21 | BridgeResolvedValue | request | 1 |  |
| S22 | BridgeInputKind | request | 1 |  |
| S25 | BridgePublicationValid | state | 1 |  |
| S26 | BridgeHostSnapshot | generation | 1 |  |
| S27 | ValidatedProfileRef | topology | 2 |  |
| S28 | ValidatedProfileAbi | metadata | 1 |  |
| S29 | ValidatedProfileGeneration | generation | 2 |  |
| S30 | LoadedBlockCount | metadata | 2 |  |
...
| S104 | ApplyGeneration | generation | 2 |  |
...
| S9 | LogicalControlCount | request | 3 | 1..32 |
| S10 | ProfileRef | request | 3 | 0 selects Memory descriptors |
| S11 | Status | state | 3 | 1 ready, negative invalid or unavailable |
| S12 | SnapshotGeneration | generation | 3 | written last |
| S13 | SelectedControlOrdinal | result | 3 |  |
| S14 | ResolvedValue | result | 3 |  |
| S15 | ResolvedInputKind | result | 1 |  |
...
| S9 | RequestedControlCount | request | 1 | 1..32 |
| S10 | SelectedControlOrdinal | result | 1 | 0 unavailable |
...
| Cells | Name | Role | Peers | Description |
|---|---|---|---:|---|
| S8 | BatchCount | request | 1 |  |
| S16 | RequestToken | request_token | 1 |  |
| S20 | Status | state | 1 |  |
| S21 | CurrentToken | current_token | 1 |  |
...
| Cells | Name | Role | Peers | Description |
|---|---|---|---:|---|
| S8 | OperationalStatus | state | 7 | positive ready |
| S9 | EffectiveConfigRevision | generation | 1 |  |
| S10 | BlockCount | metadata | 7 | 1..4 |
| S11 | TransactionResult | result | 1 | result of the transaction the header generation names |
...
| S48 | ControllerType | metadata | 8 |  |
| S50 | ControllerConfigSchema | schema | 8 |  |
| S51 | EffectiveGeneration | generation | 7 |  |
| S52 | RequestGeneration | request_token | 7 |  |
| S53 | ResponseGeneration | response_token | 7 |  |
...
| S16 | StagedQuantity | request | 1 |  |
| S17 | StagedEpoch | epoch | 1 | written after the staged identity payload |
| S18 | AllocatorRef | topology | 1 |  |
| S19 | StagedSourceReservationRef | request | 1 |  |
| S20 | StagedSinkReservationRef | request | 1 |  |
| S21 | StagedResourceType | request | 1 |  |
| S22 | StagedFeederRef | request | 1 |  |
| S23 | StagedSorterRef | request | 1 |  |
| S24 | StagedSinkProviderRef | request | 1 |  |
| S25 | StagedLinkRef | request | 1 |  |
| S26 | StagedExecutorRef | request | 1 |  |
...
| S12 | Status | state | 3 |  |
| S20..S31 | LinkRecords | table | 2 | three four-cell [LinkRef, QuantityPerJob, ResourceType, ResourceClass] records |
| S32..S83 | UnusedRecordWindow | reserved | 1 | the Stager and Allocator scan the same S20..S83 window on either resolver and bound the walk by InputCount at S9; the Link Resolver publishes at most three records and never writes here |
...
| S10 | MirroredInventoryStatus | state | 1 |  |
| S11 | MirrorGeneration | generation | 2 |  |
| S12 | ReservedExportMoles | result | 1 | Allocator-owned |
| S13 | ReservedImportMoles | result | 1 | Allocator-owned |
| S14 | BuildEpoch | epoch | 1 | Allocator-owned |
| S15 | OwningPlannerRef | topology | 1 | Allocator-owned |
| S16 | InventoryRef | topology | 0 |  |
| S17 | PressureDomainRef | topology | 0 |  |
| S18 | Role | metadata | 2 | 1 LOW, 2 HIGH, 3 STORAGE |
| S19 | MediumType | metadata | 3 |  |
| S20 | ExportableMoles | result | 3 |  |
| S21 | ImportCapacityMoles | result | 3 |  |
...
| S50 | PolicyOverride | request | 1 | POWER endpoints: consumer 0 AUTO, 1 ENABLE, 2 SHED; battery 0 AUTO, 3 CHARGE, 4 DISCHARGE, 5 HOLD |
| S51 | WattOverride | request | 1 | POWER endpoints: optional job watt override or cap |
...
|---|---|---|---:|---|
| S8 | MaxRate | result | 0 |  |
| S9 | EndpointStatus | state | 3 |  |
| S10 | Unit | metadata | 2 |  |
| S11 | PrecisionFlags | metadata | 0 |  |
| S12 | MirrorGeneration | generation | 9 | semantic mirror generation, written last |
| S13 | BuildEpoch | epoch | 4 | allocator-owned |
| S14 | ReservedExport | result | 5 | allocator-owned |
| S15 | ReservedImport | result | 5 | allocator-owned |
| S16 | DirectionLock | state | 5 | 1 export, 2 import |
| S17 | OwnerReferenceId | topology | 4 |  |
| S18 | OwnerEpoch | epoch | 4 |  |
| S19 | ReservedSemanticMirrorGeneration | generation | 4 | mirror generation captured by committed ownership |
| S22 | MirroredActionHint0 | result | 1 |  |
| S23 | MirroredActionHint1 | result | 1 |  |
| S24 | MirroredActionHint2 | result | 1 |  |
| S25 | CommittedSourceSlot | result | 3 |  |
| S26 | CommittedActionQuantity | result | 3 |  |
| S27 | CommittedDestinationSlot | result | 3 |  |
| S32 | EndpointRef | topology | 3 |  |
| S33 | ResourceClass | metadata | 5 |  |
| S34 | ResourceType | metadata | 4 |  |
| S35 | RoleBits | metadata | 0 |  |
| S36 | ExportAvailable | result | 3 |  |
| S37 | ImportCapacity | result | 3 |  |
...
| S32..S63 | OutputDescriptors | table | 3 | up to eight output descriptors, four cells each |
| S64..S67 | ConditionBounds | result | 3 | pressure and temperature bounds |
| S68 | RequestEcho | response_token | 5 | the TransformType the published view answers |
| S69 | ResolveStatus | state | 5 | 1 resolved |
| S70 | TransformTypeRequest | request_token | 2 | written by the consumer; the request and its identity |
| S71 | RequiredCapabilityMask | result | 3 | -2 and -3 publish resolution errors |
| S72 | InputCount | result | 3 |  |
| S73 | OutputCount | result | 2 |  |
| S74 | PublicationGeneration | generation | 5 |  |
