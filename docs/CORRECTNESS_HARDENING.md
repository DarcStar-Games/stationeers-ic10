...
7. **There is one request-mailbox writer.** The Store does not arbitrate concurrent command producers. `ic10/manufacturing/manufacturing_scheduler_v1_0.ic10` owns TRANSFORM/PRINT lifecycle policy, but Gateway ABI5 serializes command lanes and `ic10/generic-jobs/generic_job_store_command_executor_v1_0.ic10` is the sole physical Job Store mailbox writer.
