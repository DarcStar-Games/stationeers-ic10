...
| `ic10/manufacturing/transform_candidate_executor_v2_0.ic10` | 83 | Manufacturing execution | `manufacturing` | `conditional-resident` | Evaluates and launches one transform candidate through the existing Admission/Resolver/Stager/Allocator/Runtime transaction. |
