...
| `ic10/live-commissioning/stack_cell_monitor_v1_0.ic10` | 53 | On-demand commissioning | `live-commissioning` | `on-demand` | Read-only target IC stack-cell monitor with a Logic Memory address selector and visible value mirror. |
