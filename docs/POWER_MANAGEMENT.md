...
`generate_resource_profiles.py` produces Loader ABI4 candidates `ic10/resource-profile-catalog/resource_profile_loader_power_00_v4_0.ic10` and `ic10/resource-profile-catalog/resource_profile_loader_energy_00_v4_0.ic10`. POWER/ENERGY are ordinary Resource Profile items; Store ABI5 and Coordinator ABI3 are unchanged.
