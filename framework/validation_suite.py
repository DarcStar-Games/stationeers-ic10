...
SUITE_ENTRIES = (
    ...
    SuiteEntry("validation/validators/validate_operator_order_ingress_contracts.py", VALIDATOR_CATEGORY, "VALIDATE_OPERATOR_ORDER_INGRESS_CONTRACTS"),
    ...
    SuiteEntry("validation/validators/validate_register_seeding.py", VALIDATOR_CATEGORY, "VALIDATE_REGISTER_SEEDING"),
    SuiteEntry("validation/validators/validate_identity_coverage.py", VALIDATOR_CATEGORY, "VALIDATE_IDENTITY_COVERAGE"),
    SuiteEntry("validation/validators/validate_network_provenance.py", VALIDATOR_CATEGORY, "VALIDATE_NETWORK_PROVENANCE"),
    ...
    SuiteEntry("validation/validators/validate_stack_field_map.py", VALIDATOR_CATEGORY, "VALIDATE_STACK_FIELD_MAP"),
    ...
    SuiteEntry("tests/test_operator_order_ingress.py", TEST_CATEGORY, "TEST_OPERATOR_ORDER_INGRESS"),
    ...
    SuiteEntry("tests/test_register_seeding.py", TEST_CATEGORY, "TEST_REGISTER_SEEDING"),
    SuiteEntry("tests/test_identity_coverage.py", TEST_CATEGORY, "TEST_IDENTITY_COVERAGE"),
    SuiteEntry("tests/test_network_provenance.py", TEST_CATEGORY, "TEST_NETWORK_PROVENANCE"),
    ...
    SuiteEntry("tests/test_stack_field_map.py", TEST_CATEGORY, "TEST_STACK_FIELD_MAP"),
