...
if (C.STORE_MAGIC,C.STORE_ABI,C.LOADER_MAGIC,C.LOADER_ABI,C.COORD_MAGIC,C.COORD_ABI)!=(31415968,6,31415969,5,31415970,3):fails.append('Catalog common ABI constants mismatch')
...
if src.stack.get(16)!=5 or dst.stack.get(21,0)!=0:fails.append('empty compacted Store retirement/unlink failed')
...
print(' - Store ABI6 uses a runtime item directory + downward payload heap; Loader ABI5 carries relocatable whole items')
