...
for n in ('poke 0 31415981','poke 1 1','bgt r3 64 Error','add r10 r6 29','poke r10 r9','mul r4 r2 r3'):
...
dir=Device(700,stack={0:31415981,1:1,24:0,25:9,27:5,29:0,9:'HASH:DirectorySchema.Controller.v1',11:2,12:64})
