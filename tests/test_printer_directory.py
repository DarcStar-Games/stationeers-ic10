...
if av.stack.get(0)!=31415983 or av.stack.get(1)!=2 or av.stack.get(2)!='HASH:DirectorySchema.Printer' or av.stack.get(3)!=2 or av.stack.get(4)!=3 or av.stack.get(5)!=64:
    fails.append('Printer Adapter ABI2 header mismatch')
