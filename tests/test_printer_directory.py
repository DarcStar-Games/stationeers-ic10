...
if hd.stack.get(0)!=31415981 or hd.stack.get(1)!=1 or hd.stack.get(9)!='HASH:DirectorySchema.Printer' or hd.stack.get(10)!=2 or hd.stack.get(11)!=3 or hd.stack.get(12)!=64:
    fails.append('Generic Snapshot Printer schema header mismatch')
if av.stack.get(0)!=31415983 or av.stack.get(1)!=3 or av.stack.get(2)!=17 or av.stack.get(3)!='HASH:DirectorySchema.Printer.v2' or av.stack.get(8)!='HASH:DirectorySchema.Printer' or av.stack.get(9)!=2 or av.stack.get(10)!=3 or av.stack.get(11)!=64:
