...
printer_dir=Device(100,stack={0:31415981,1:1,2:0,3:5,5:2,7:0,9:'HASH:DirectorySchema.Printer.v2',11:3,12:64,
...
sel.stack.update({2:'HASH:DirectorySchema.Printer.v2',3:'HASH:Printer.Autolathe',4:2,5:2,6:0,7:1,15:2,16:100});sel.run(1)
ck(sel.stack.get(9)==1 and sel.stack.get(10)==502 and sel.stack.get(13)==2,'printer tier candidate selection mismatch')
sel.stack.update({7:2,2:'HASH:DirectorySchema.Printer.v1',16:100});sel.run(1);ck(sel.stack.get(9)==-1,'candidate selector accepted a schema identity at the wrong version')
transform_dir=Device(101,stack={0:31415981,1:1,2:0,3:7,5:1,7:0,9:'HASH:DirectorySchema.TransformLane.v1',11:3,12:64,
...
ts.stack.update({2:'HASH:DirectorySchema.TransformLane.v1',3:0,4:4,5:1,6:0,7:1,15:1,16:101});ts.run(1)
