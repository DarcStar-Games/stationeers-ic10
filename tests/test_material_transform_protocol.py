...
# the Allocator after delivery: the echo, status 2, and the completed epoch at S15 that the Runtime mirrors (issue #204)
snap_alloc=Device(965,stack={15:1,16:3,22:2},props={'ReferenceId':965})
