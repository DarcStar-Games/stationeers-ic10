...
cons=Device(702,stack={0:17320509,1:1,4:705,5:1,10:0,11:0,14:1},props={'ReferenceId':702})
renderer=Device(703,stack={0:16180339,1:1,2:0},props={'ReferenceId':703})
inp=Device(704,stack={0:17320511,1:1,7:1,19:1,20:0,21:6,23:1,24:2,25:1},props={'ReferenceId':704})
...
me.stack.update({2:702,3:701,4:703,7:704})
me.run(2)
ck(renderer.stack.get(2,0)==0 and me.stack.get(6)==-2,'Mapping Editor consumed stale Controller Selector success')
cs.stack.update({5:707,13:2,8:1});me.run(1)
ck(renderer.stack.get(2)==1 and renderer.stack.get(65)==707,'Mapping Editor did not commit after Controller Selector token caught up')
...
cons2=Device(712,stack={0:17320509,1:1,4:705,5:1,10:4,11:3,14:2},props={'ReferenceId':712})
renderer2=Device(713,stack={0:16180339,1:1,2:0},props={'ReferenceId':713})
inp2=Device(714,stack={0:17320511,1:1,7:1,19:2,20:0,21:6,23:1,24:3,25:2},props={'ReferenceId':714})
...
me2.stack.update({2:712,3:711,4:713,7:714});me2.run(2)
ck(renderer2.stack.get(2,0)==0,'Mapping Editor consumed console result while auto-advance response was stale')
cons2.stack.update({4:715,11:4,5:1});me2.run(1)
ck(renderer2.stack.get(2)==1 and renderer2.stack.get(64)==715,'Mapping Editor did not resume after console advance token caught up')
