...
a.run(2)
ck(a.stack.get(20)==3 and releaser.stack.get(2)==10,'allocator did not release prior epoch before republish')
releaser.stack.update({4:req,5:1})
a.run(2)
...
res=Device(3103,stack={0:31415950,2:3102,3:4,17:3100,18:10,19:6,28:2,31:8},props={'ReferenceId':3103})
...
link=Device(3204,stack={0:31415953,4:4,6:2,10:3201,12:9},props={'ReferenceId':3204})
