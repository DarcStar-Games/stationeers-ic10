...
if compact_monitor.stack.get(8)!=1 or compact_monitor.stack.get(10)!=42:
...
no_target.run(2)
if no_target.stack.get(8)!=-1 or no_target.stack.get(10)!=0:
